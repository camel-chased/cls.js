...
"",r,t,B="",m="",p=!0;for(f(c)||(c="");g<e;g++)if(p=d[g],f(b[p]))if(r=a[p],t=b[p],B=l(r),m=l(t),"object"===B||"function"===B){if(p=ba(r,t,c+"."+p),!p)return!1}else if(B!==m)throw c=c+"."+p,c=c.substr(1),Error("Type mismatch. Object property [ "+c+" ] should be an "+m+".\n'"+B+"' given.");return!0}function Da(a,b,c,d){var e={},g=RegExp("^\\s?\\@method[ \\t]+([^\\s]+)[ \\t]*(?:([^\\n \\t]+))?(?:[ \\t]+([^\\n]+))?\\s?$","gim"),p=b.obj;b=b.className;var r=RegExp("^\\@returns?[ \\t]+\\{([^\\}]+)\\}","gim"),
...
a.str,p=a.obj,r=RegExp("\\/\\*\\*?\\s*([^\\/]+)","gim");c=new RegExp(c,"gim");for(var t="",B="",t="",m=[],q="",l={};f(m);)if(m=r.exec(g),f(m)&&(q=String(m[1]).replace(/^[\t\*]+/gim,"").replace(/[\*]+/gim,"").replace(/^[ \t\n]{2,50}/gi,"").replace(/\n/gi,"").replace(/(\@)/gi,"\n$1").replace(/^\s+/gim,"").replace(/\s+$/gim,"").trim(),c.lastIndex=0,t=c.exec(q),f(t))){B=t[1].trim();t=t[2].trim();l[t]={};if("method"===B)q=Da(q,a,d,e),l[q[0]]=q[1];else if("property"===B){var w=q,N=d,q=e,k=a.className,u=
a.obj,y={},n=RegExp("^\\s?\\@property[ \\t]+\\{([^\\}]+)\\}[ \\t]+([^ \\t\\r\\n]+)[ \\t]*([^\\s\\*\\/]+)?(?:[ \\t]+([^\\n\\/]+))?$","gim"),h=void 0,z=void 0,v=!1;f(N)||(v=!0);h=n.exec(w);if(f(h)){z=h[2];if(!v&&!I(q,z,N))throw Error("Cannot override '"+z+"' property.");y[z]={};y[z].str=w;y[z].types=h[1].split("|");y[z].value=u[z];y[z].classId="static:"+k;f(N)&&(y[z].classId=N);y[z].className=k;if(f(h[3])){w=[h[3]];f(h[4])&&w.push(h[4]);if(v&&-1===w.indexOf("static"))throw Error("It should  be static property or classId is undefined.");
Z(w,k,z,!1)&&(y[z].declarations=w)}else f(y[z].declarations)||(y[z].declarations=["public"])}else throw Error("I see death people.");F(y[z],k,z,v);f(q)&&(q[z]=y[z]);q=[z,y[z]];l[q[0]]=q[1]}if("undefined"===typeof p[t])throw Error("Class "+B+" [ "+t+" ] is declared but not defined in [ "+b+" ] class.");}return l}function ca(a,b){var c={};A(a,function(a,e){c[e]=a.value;Object.defineProperty(b,e,{enumerable:!0,get:function(){return"function"===typeof a.value?a.value.bind(c):a.value}})})}function F(a,
...
new Function("return "+a.data),!0));"extend"===a.type&&(b=T(a.data.firstClass.__compressedClass),a=T(a.data.secondClass.__compressedClass),b=k.extend(b,a));return b}function x(a,b,c){Object.defineProperty(a,b,{enumerable:!1,get:function(){return c}})}function na(a,b,c){var d=c;Object.defineProperty(a,b,{enumerable:!1,get:function(){return d},set:function(a){d=a}})}function Pa(a,b){var c={};A(a,function(a,e){f(a.declarations)&&-1!==a.declarations.indexOf("static")&&(c[e]=F(a,b,e,!0))});return c}function C(a){for(var b=
"",c=0;c<a;c++)b+="  ";return b}function oa(a,b){var c;if(0===a.length)return"";c=""+a[0].trim();1<a.length&&(c+="\n");if(3<=a.length){for(var d=1;d<a.length-1;d++)c+=C(b+1)+a[d].trim()+"\n";c+=C(b)+a[a.length-1].trim()}else 2===a.length&&(c+=C(b)+a[1].trim());return c}function pa(a,b){var c="",d=l(a);"function"===d?(d=a.toString().split("\n"),c+=oa(d,b)):"object"===d?c+=qa(a,b+1):"array"===d?0<a.length?(c=1<a.length?c+("\n"+C(b)+"[\n"):c+"[ ",A(a,function(e,d){1<a.length&&(c+=C(b+1));c+=pa(e,b+2)}),
c=1<a.length?c+("\n"+C(b)+"]"):c+" ]"):c+="[]":"string"===d?(d=a.replace(/\"{1}/gim,'\\"').replace(/^/gim,'"').replace(/\n{1}/gim,'\\n"+\n').substr(1).split("\n"),c+='"'+oa(d,b-1)+'"'):c+=a.toString();return c}function qa(a,b){var c="{\n";if("object"!==l(a))throw Error("This is not an object.");A(a,function(a,e){c+=C(b+1)+'"'+e+'":'+pa(a,b+1);"object"!==l(a)&&(c+=",");c+="\n"});c+=C(b-1)+"}";0!==b&&(c+=",");return c}function ra(){var a=this.asObject();return qa(a,0)}function sa(a){var b=this.___className,
b="// Auto generated class\n\n"+("var "+b+"Source = "+this.asString()+";\nvar "+b+" = cls.class("+b+","+b+"Source);\n");if(f(module))if(f(module.exports))require("fs").writeFileSync(a,b);else return!1;else return!1}function ta(){var a={};if(f(module)&&f(module.exports))return a.className=this.___className,"class"===this.___type?(a.type="class","function"===l(this.___source)?(a.source={},Q(this.___sourceObject,this.___className,void 0,"asObjectId",a.source),A(a.source,function(a,c){delete a.classId})):
a.source=this.___source):(a.type="extend",a.firstClass=toObject.call(this.firstClass),a.secondClass=toObject.call(this.secondClass)),a}function ma(a,b,c){var d="",e=d="",g={},p={},d=Object.keys(E);if(!f(a)&&!f(b))throw Error("There is no source for class creation.");if(c){if(-1!==d.indexOf(a))return E[a]}else if(-1!==d.indexOf(a))throw Error("Class [ "+a+" ] is already defined.");d=l(a);if(("function"===d||"classConstructor"===d)&&f(a.isConstructor))return a;if("string"!==d)throw Error("class name should be a string");
d=l(b);"function"===d?(e=b.toString(),g=b(),p={className:a,source:b,str:e,obj:g}):(e="object",g={},A(b,function(a,b){g[b]=a.value}),b=p={className:a,source:H(b),str:e,obj:g});if("function"!==d&&"object"!==d)throw Error("Source for class creation must be inline function or specially prepared object.");e=function(){var c=arguments,e=k.create(a,b),c=S(e,c);return"undefined"===l(c)?e:"clsClassFacade"===l(c)?(e=c.getClassId(),v[e].classInstance):c};x(e,"___type","class");x(e,"___source",b);x(e,"___sourceObject",
...
r.getClassId();g.parentName=r.getCurrentClassName();g.inherits=Sa(e);g.child="";p=g.getClassId();t.child=p;var l=e.getClassId();A(c,function(a,b){a.classId!==l&&(g.___addProperty(b,a,!1),K(a,"public")&&e.___addPublicProperty(b))});return e}function va(a){var b=a[0];A(a,function(a,d){0<d&&(b=k.extend(b,a))});return b}function ua(a,b){if("string"===l(a)){var c=k["class"](a,b);return k.extend(this,c)}return k.extend(this,a)}function W(){var a="undefined"!==typeof process&&"undefined"!==typeof module;
...
"base64");a.writeSync(b,c,0,c.length);console.log("Done!")}var k=function(a,b,c){return k.create(a,b,c)};k.type=l;var Aa=Object.prototype.hasOwnProperty,za=Object.prototype.toString;k.guid=Y;k["var"]=function(a,b){var c={},d="",e="",g=0,p=0,r="",t;f(b)||(b="");e=Object.keys(a);for(p=e.length;g<p;g++)d=e[g],t=a[d],r=l(t),function(a,b,c,e,d,g){var r="",t=!0,p={};"object"===e||"function"===e?(p=k["var"](d[c],g+"."+c),Object.defineProperty(a,c,{get:function(){return p},set:function(a){var b=l(a);if(b!==
e&&"anytype"!==e)throw g=g+"."+c,g=g.substr(1),Error("Type mismatch. Object [ "+g+" ] should be an "+e+".\n'"+b+"' given.");(t=ba(a,d[c],g+"."+c))&&(d[c]=p)}})):Object.defineProperty(a,c,{get:function(){return d[c]},set:function(a){r=l(a);if(r!==e&&"anytype"!==e)throw g=g+"."+c,g=g.substr(1),Error("Type mismatch. Object [ "+g+" ] should be an "+e+",");d[c]=a}})}(c,t,d,r,a,b);return c};var J=K;Object.defineProperty(da.prototype,"___addPublicProperty",{enumerable:!1,configureable:!1,get:function(){return Ia}});
...
function(a,b){function c(){var c;a:{c=p;var d=arguments,B,m,q="",k=0,w=[];if(f(c.classProperties[b]))if(f(c.classProperties[b].arguments)){B=c.classProperties[b].arguments;if(0===B.length){c=Array.prototype.slice.call(d);break a}for(k in B)m=B[k],Object.prototype.hasOwnProperty.call(B,k)&&(f(d[k])?w[k]=d[k]:f(m["default"])?w[k]=m["default"]:m.types.indexOf("undefined")?w[k]=void 0:aa(c.classInstance.getCurrentClassName(),b,m.name,m.types,"undefined"),q=l(w[k]),"clsClassInstance"===q?(q=c.classFacade.getClassName(),
R(w[k],m.types,q,m.name)):-1===m.types.indexOf(q)&&"anytype"!==m.types[0]&&aa(c.classInstance.getCurrentClassName(),b,m.name,m.types,q))}else{c=Array.prototype.slice(d);break a}else throw Error("There is no such method like ",b);c=w}c=e.value.apply(g,c);d=v[a];k=d.classProperties;B=l(c);m=d.classFacade.getClassName();"clsClassInstance"===B&&(B=c.getClassName());if(!f(k[b]))throw Error("There is no method called '"+b+"' in [ "+m+" ] class.");k=k[b].returns;if(!(0<=k.indexOf("anytype"))&&-1===k.indexOf(B))throw Error("Type mismatch. Method [ "+
b+" ] from [ "+m+" ] class, should return '"+k.join(",")+"', not '"+B+"'.");c="clsClassFacade"===B?d.classInstance:c;return c}var d=v[a].classFacade.getCurrentClassName();if(!this.propertyExists(b))throw Error("There is no property like "+b+" in "+d);var e=this.classProperties[b];if(f(e)){if(e.classId===a){if("function"===l(e.value)){var g=this.classFacades[a],p=v[a];return c}return e.value}if(K(e,"public")||f(a)&&K(e,"protected")&&this.mixedWithOrChildOfPropertyOwner(a,b))return v[e.classId].classFacade.getCurrentClassName(),
this.get(e.classId,b);if(f(a)&&K(e,"private"))throw Error("Cannot access private properties of other classes.");throw Error("Cannot access '"+b+"' from outside a class.");}};D.prototype.set=function(a,b,c,d){var e=v[a],g=e.classProperties[c].classId,p=e.classFacade,r=e.classProperties[c];if("function"===l(r.value)){if(J(r,"final"))throw Error("Method '"+c+"' is declared as final and cannot be changed.");}else if(J(r,"const"))throw Error("Property '"+c+"' is declared as const and cannot be changed.");
ha(a,b,d,c);if(a===g)e.classProperties[c].value=d;else if(-1!==p.inherits.indexOf(g))e.classProperties[c].value=d;else throw Error("Cannot change property '"+c+"' only child classes can redefine properties.");};var E={},v={};k.compress=function(a){if(f(a.isConstructor))return a.compress();a=ka(a);a=JSON.stringify(a);return L.compressToUint8Array(a)};k.decompress=function(a){a=L.decompressFromUint8Array(a);if(null===a)throw Error("Cannot decompress file.");a=JSON.parse(a);return f(a.__compressedClass)?
T(a.__compressedClass):la(a)};k["class"]=function(a,b){return ma(a,b,!1)};k.create=function(a,b){return U(a,b)};var M={};k.extend=function(a,b){if("array"===l(a))return va(a);var c=Array.prototype.slice.call(arguments);if(2<c.length)return va(c);c=function(){var c=arguments,d=V(a,b),c=S(d,c);return"undefined"===l(c)?d:c};x(c,"___firstClass",a);x(c,"___secondClass",b);x(c,"___arguments",arguments);x(c,"___type","extend");x(c,"___className",b.___className);x(c,"isConstructor",!0);x(c,"extend",ua.bind(c));
na(c,"compressed","");x(c,"compress",P.bind(c));x(c,"asObject",ta.bind(c));x(c,"asString",ra.bind(c));x(c,"saveAsObject",sa.bind(c));var d=X(a.___static,b.___static);x(c,"___static",d);ca(d,c);return M[b.___className]=c};k.empty=function(a){return k["class"](a,function(){return{}})};k.getSingleClass=function(a){if(!f(E[a]))throw Error("Cannot find [ "+a+" ] class.");return E[a]};k.getClass=function(a){if(f(M[a]))return M[a];if(f(E[a]))return E[a];throw Error("Cannot find [ "+a+" ] class.");};k.loadBundle=
function(){Ua.get("build.cls").done(function(a){a=L.decompressFromUint8Array(a);a=JSON.parse(a);k.deBundle(a)})};k.deBundle=function(a){A(a,function(a,c){var d=a.replace("module.exports","cls.module.exports");k.module={exports:void 0};eval(d);f(k.module.exports)&&f(k.module.exports.isConstructor)&&(d=k.module.exports.___className,M[d]=k.module.exports,"undefined"!==typeof window&&(window[d]=k.module.exports),"undefined"!==typeof GLOBAL&&(GLOBAL[d]=k.module.exports))});console.log("debundled",M)};
k.require=function(a){if(W())return require(a);a=classNameFromPath(a);return k.getClass(a)};var wa={},xa="",ya,Ua={request:function(a){"string"===typeof a&&(a={url:a});a.url=a.url||"";a.method=a.method||"get";a.data=a.data||{};var b=function(a,b){var e=[],g;for(g in a)e.push(g+"="+encodeURIComponent(a[g]));e=e.join("&");return""!==e?b?0>b.indexOf("?")?"?"+e:"&"+e:e:""};return{host:{},process:function(a){var d=this;this.xhr=null;window.ActiveXObject?this.xhr=new ActiveXObject("Microsoft.XMLHTTP"):
window.XMLHttpRequest&&(this.xhr=new XMLHttpRequest);this.xhr&&(this.xhr.responseType="arraybuffer",this.xhr.onreadystatechange=function(){if(4===d.xhr.readyState&&200===d.xhr.status){var a=new Uint8Array(d.xhr.response);d.doneCallback&&d.doneCallback.apply(d.host,[a,d.xhr])}else 4===d.xhr.readyState&&d.failCallback&&d.failCallback.apply(d.host,[d.xhr]);d.alwaysCallback&&d.alwaysCallback.apply(d.host,[d.xhr])});"get"===a.method?this.xhr.open("GET",a.url+b(a.data,a.url),!0):(this.xhr.open(a.method,
a.url,!0),this.setHeaders({"X-Requested-With":"XMLHttpRequest","Content-type":"text/plain; charset=x-user-defined"}));a.headers&&"object"===typeof a.headers&&this.setHeaders(a.headers);setTimeout(function(){"get"===a.method?d.xhr.send():d.xhr.send(b(a.data))},20);return this},done:function(a){this.doneCallback=a;return this},fail:function(a){this.failCallback=a;return this},always:function(a){this.alwaysCallback=a;return this},setHeaders:function(a){for(var b in a)this.xhr&&this.xhr.setRequestHeader(b,
a[b])}}.process(a)},get:function(a,b){return this.request({url:a,data:b,method:"get"})},post:function(a,b){return this.request({url:a,data:b,method:"post"})}},L=function(){function a(a,b){if(!c[a]){c[a]={};for(var d=0;d<a.length;d++)c[a][a.charAt(d)]=d}return c[a][b]}var b=String.fromCharCode,c={},d={compressToBase64:function(a){if(null==a)return"";a=d._compress(a,6,function(a){return"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(a)});switch(a.length%4){default:case 0:return a;
...
d.compress(a);for(var b=new Uint8Array(2*a.length),c=0,r=a.length;c<r;c++){var t=a.charCodeAt(c);b[2*c]=t>>>8;b[2*c+1]=t%256}return b},decompressFromUint8Array:function(a){if(null===a||void 0===a)return d.decompress(a);for(var c=Array(a.length/2),f=0,r=c.length;f<r;f++)c[f]=256*a[2*f]+a[2*f+1];var t=[];c.forEach(function(a){t.push(b(a))});return d.decompress(t.join(""))},compressToEncodedURIComponent:function(a){return null==a?"":d._compress(a,6,function(a){return"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$".charAt(a)})},
...
q)||(k[q]=x++,m[q]=!0),l=w+q,Object.prototype.hasOwnProperty.call(k,l))w=l;else{if(Object.prototype.hasOwnProperty.call(m,w)){if(256>w.charCodeAt(0)){for(d=0;d<u;d++)n<<=1,h==b-1?(h=0,y.push(c(n)),n=0):h++;f=w.charCodeAt(0);for(d=0;8>d;d++)n=n<<1|f&1,h==b-1?(h=0,y.push(c(n)),n=0):h++,f>>=1}else{f=1;for(d=0;d<u;d++)n=n<<1|f,h==b-1?(h=0,y.push(c(n)),n=0):h++,f=0;f=w.charCodeAt(0);for(d=0;16>d;d++)n=n<<1|f&1,h==b-1?(h=0,y.push(c(n)),n=0):h++,f>>=1}v--;0==v&&(v=Math.pow(2,u),u++);delete m[w]}else for(f=
k[w],d=0;d<u;d++)n=n<<1|f&1,h==b-1?(h=0,y.push(c(n)),n=0):h++,f>>=1;v--;0==v&&(v=Math.pow(2,u),u++);k[l]=x++;w=String(q)}if(""!==w){if(Object.prototype.hasOwnProperty.call(m,w)){if(256>w.charCodeAt(0)){for(d=0;d<u;d++)n<<=1,h==b-1?(h=0,y.push(c(n)),n=0):h++;f=w.charCodeAt(0);for(d=0;8>d;d++)n=n<<1|f&1,h==b-1?(h=0,y.push(c(n)),n=0):h++,f>>=1}else{f=1;for(d=0;d<u;d++)n=n<<1|f,h==b-1?(h=0,y.push(c(n)),n=0):h++,f=0;f=w.charCodeAt(0);for(d=0;16>d;d++)n=n<<1|f&1,h==b-1?(h=0,y.push(c(n)),n=0):h++,f>>=1}v--;
0==v&&(v=Math.pow(2,u),u++);delete m[w]}else for(f=k[w],d=0;d<u;d++)n=n<<1|f&1,h==b-1?(h=0,y.push(c(n)),n=0):h++,f>>=1;v--;0==v&&u++}f=2;for(d=0;d<u;d++)n=n<<1|f&1,h==b-1?(h=0,y.push(c(n)),n=0):h++,f>>=1;for(;;)if(n<<=1,h==b-1){y.push(c(n));break}else h++;return y.join("")},decompress:function(a){return null==a?"":""==a?null:d._decompress(a.length,32768,function(b){return a.charCodeAt(b)})},_decompress:function(a,c,d){var f=[],k=4,l=4,m=3,q="",v=[],w,x,A,u,y,n=d(0),h=c,z=1;for(w=0;3>w;w+=1)f[w]=w;
q=0;A=Math.pow(2,2);for(u=1;u!=A;)x=n&h,h>>=1,0==h&&(h=c,n=d(z++)),q|=(0<x?1:0)*u,u<<=1;switch(q){case 0:q=0;A=Math.pow(2,8);for(u=1;u!=A;)x=n&h,h>>=1,0==h&&(h=c,n=d(z++)),q|=(0<x?1:0)*u,u<<=1;y=b(q);break;case 1:q=0;A=Math.pow(2,16);for(u=1;u!=A;)x=n&h,h>>=1,0==h&&(h=c,n=d(z++)),q|=(0<x?1:0)*u,u<<=1;y=b(q);break;case 2:return""}w=f[3]=y;for(v.push(y);;){if(z>a)return"";q=0;A=Math.pow(2,m);for(u=1;u!=A;)x=n&h,h>>=1,0==h&&(h=c,n=d(z++)),q|=(0<x?1:0)*u,u<<=1;switch(y=q){case 0:q=0;A=Math.pow(2,8);for(u=
1;u!=A;)x=n&h,h>>=1,0==h&&(h=c,n=d(z++)),q|=(0<x?1:0)*u,u<<=1;f[l++]=b(q);y=l-1;k--;break;case 1:q=0;A=Math.pow(2,16);for(u=1;u!=A;)x=n&h,h>>=1,0==h&&(h=c,n=d(z++)),q|=(0<x?1:0)*u,u<<=1;f[l++]=b(q);y=l-1;k--;break;case 2:return v.join("")}0==k&&(k=Math.pow(2,m),m++);if(f[y])q=f[y];else if(y===l)q=w+w.charAt(0);else return null;v.push(q);f[l++]=w+q.charAt(0);k--;w=q;0==k&&(k=Math.pow(2,m),m++)}}};return d}();if(W()&&(GLOBAL.cls=k,2<process.argv.length))switch(process.argv[2]){case "build":Ta()}W()&&
(module.exports=k);return k}();
